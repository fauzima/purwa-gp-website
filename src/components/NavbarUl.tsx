          ...
          <li key={idx}>
            <Link
              ...
              className={classNames(
                isActive
                  ? "w-24 h-9 flex items-center justify-center text-sky-500 rounded-md ring-1 ring-slate-900/5 shadow-sm hover:shadow hover:ring-slate-900/10 dark:ring-0 dark:shadow-none dark:hover:shadow-none hover:shadow-indigo-200 bg-white/50 dark:bg-sky-600/25 transition ease-in-out"
